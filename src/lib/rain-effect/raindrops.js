...
// Adaptations: removed GSAP dependency, exposed destroy() for SPA cleanup,
// import path changed to bundled util module.

import { createCanvas, random, chance, times } from './util.js';
					...
					this.drops.slice(i + 1, i + 70).forEach((drop2) => {
						if (
							...
							if (
								...
								if (targetR > this.maxR) targetR = this.maxR;
								drop.r = targetR;
